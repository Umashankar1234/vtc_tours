...
export default function AgentMylisting(props) {
  ...
  useEffect(() => {
    ...
    if (themeId === 1) {
      ...
      window.location.href =
        "http://139.59.28.82/vtc_tours/theme-template/" +
        id +
        APIPath() +
        agent_id;
      setThemeId("");
      ...
      window.location.href =
        "http://139.59.28.82/vtc_tours/theme-template1/" +
        id +
        APIPath() +
        agent_id;
      setThemeId("");
      ...
      window.location.href =
        "http://139.59.28.82/vtc_tours/theme-template2/" +
        id +
        APIPath() +
        agent_id;
      // window.location.href = "http://localhost:3001/theme-template/" +  id + APIPath() + agent_id;
      ...
      window.location.href =
        "http://139.59.28.82/vtc_tours/theme-template3/" +
        id +
        APIPath() +
        agent_id;
      setThemeId("");
  ...
  const saveContactAgent = () => {
    ...
    if (captcha == user.username) {
      ...
      postRecord(APISendContactMail, contactMail).then((res) => {
        if (res.data[0].response.status === "success") {
          setOpen(false);
          setOpenSuccess(true);
          setMessage();
      ...
      <section class="container">
        ...
        >
          ...
          <div class="col-lg-12">
            ...
            >
              <h6
                style={{ color: "whitesmoke", margin: "5px", fontSize: "16px" }}
              >
                {currentUser.name}
              </h6>
              <h6
              ...
              <h6
                style={{ color: "whitesmoke", margin: "5px", fontSize: "16px" }}
              >
                {companyInformation.officephone}
              </h6>
            </div>
          </div>
          <div class="col-lg-12">
            ...
            >
              <div class="card" style={{ height: "100%" }}>
                <img
                  ...
                  src={res.filename}
                  alt="Card image cap"
                  style={{ height: "260px", border: "5px solid white" }}
                />
                <div class="card-body">
              ...
              <div class="agent_pop_main">
                <div class="">
                  ...
                  <div class="menu_opt_sec">
                    ...
                    <div class="mar_top row">
                      ...
                      <div class="col-md-8" style={{ marginBottom: "15px" }}>
                        <input
                          type="email"
                          name="contact_email"
                          value={contactMail.contact_email}
                          onChange={inputHandleChange}
                          class="form-control"
                          required
                        />
                    ...
                    <div class="mar_top row">
                      <div class="col-md-8">
                        <h3 id="captcha" style={{ margin: "10px" }}>
                          {captcha}
                        </h3>
                        <button
                          id="succesBTN"
